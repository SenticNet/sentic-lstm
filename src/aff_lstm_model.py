...
from utils import _multi_bilayer_attention
from feat_bilstm_model import FeatBiLSTM_Model


class AffLSTM_Model(AttLSTM_Model):
    ...
    def __init__(self,num_classes,max_length,num_tokens,embd,emb_dim = 300,hidden_dim=100,concept_vector=None,num_ways =3,lr=0.001,cell='recall'):
        ...
        super(AffLSTM_Model,self).__init__(num_classes,max_length,num_tokens,embd,emb_dim=emb_dim,hidden_dim=hidden_dim,num_ways =num_ways,lr=lr)
