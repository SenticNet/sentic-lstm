...
from utils import *
from avg_lstm_model import AvgLSTM_Model
from utils import _lengths_to_masks,_multi_bilayer_attention



class BiAvgLSTM_Model(AvgLSTM_Model):

    def __init__(self,num_classes,max_length,num_tokens,embd,emb_dim = 300,hidden_dim=100,num_ways =3,lr=0.001):
        
        super(BiAvgLSTM_Model,self).__init__(num_classes,max_length,num_tokens,embd,emb_dim=emb_dim,hidden_dim=hidden_dim,num_ways =num_ways,lr=lr)
    ...
    def global_attention_forward(self, lstm_outputs,targets,lengths):
        ...
        target_outputs = self.target_avg(lstm_outputs,targets)
